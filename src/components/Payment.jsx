    ...
    return (
        <div className={styles.payment}>
            <div>
                <div>
                    <div>
                        <img src='src/assets/card_icon.svg' alt='Card' />
                        <button>+</button>
                    </div>
                    <div>
                        ...
                        <select>
                            ...
                            <option>Mastercard **** <span>5432</span></option>
                            <option>Visa **** <span>2345</span></option>
                            <option>Mastercard **** <span>9876  </span></option>
                        </select>
                    </div>            
                    ...
                    <div>
                        <div>
                            <label for="monthYearPicker">Data de Expiração:</label>
                            <input type="month" id="monthYearPicker" name="monthYearPicker" />
                        </div>
                        <div>
                            <label for="monthYearPicker">CCV:</label>
                            <input placeholder='# # #'/>
                        </div>
                    </div>
                    <p>
                        <button type="button" onClick={()=>setOpenModal(true)} >RESERVAR</button>
                    </p>
                </div>
                ...
                <div>
                    <div>
                        <img src={filme.poster} alt='Movie'/>
                        <div>
                    ...
                    <div className={styles.saleList}>
                        <div>
                            <p>Proprietário: <span>M DMF D</span></p>
                            <p>Fileira: <span>A</span></p>
                            <p>Número: <span>12</span></p>                           
                            <p>Valor: <span>R$49,99</span></p> 
                            <button><img src='src/assets/trash_icon.svg' alt='Trash'/></button>                          
                        </div>
                        <div>
                            <p>Proprietário: <span>M DMF D</span></p>
                            <p>Fileira: <span>A</span></p>
                    ...
                    <p>TOTAL:<span>R$dncdsklcndskl</span></p>
                </div>
            </div>
        </div>
    )
